<div class="container mx-auto bg-white rounded-lg shadow-lg p-6 md:p-10" x-data="{ showInviteDialog: false }">
    ...
    <div class="sm:grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 my-4">
        ...
        <div @click="showInviteDialog = true" class="text-center rounded px-4 py-8 border-2 border-dashed border-gray-300 opacity-50 hover:opacity-100 cursor-pointer">
                ...
                <div class="">
                    ...
                    <div class="mt-2">
                        <p class="text-sm leading-5 text-gray-500">
                            Provide an email address and we'll invite them to join this team
                        </p>
                    </div>
                    <div class="mt-2">
                        <p class="text-sm leading-5 text-gray-500">
