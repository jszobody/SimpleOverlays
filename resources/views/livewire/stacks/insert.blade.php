<div x-show="showInsertDialog"
     class="hidden fixed bottom-0 inset-x-0 px-4 pb-6 sm:inset-0 sm:p-0 sm:flex sm:items-center sm:justify-center">
    <div x-show="showInsertDialog" x-transition:enter="ease-out duration-300" x-transition:enter-start="opacity-0"
    ...
    <div x-show="showInsertDialog" x-transition:enter="ease-out duration-300"
        ...
        <div>
            <div class="absolute right-0 top-0 text-gray-500 p-4 cursor-pointer" @click="showInsertDialog = false"><i class="fas fa-times"></i></div>
            <div class="">
        ...
        <div class="mt-5 sm:mt-6">
            <span class="flex w-full rounded-md shadow-sm">
                    ...
                    <button type="button" {{ $selected ? '' : 'disabled' }} wire:click="insert()" @click="showInsertDialog = false"
