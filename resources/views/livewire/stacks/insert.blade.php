<div x-data="{show: true}" x-show="show"
    ...
    <div x-show="show" x-transition:enter="ease-out duration-300"
        ...
        <div>
            <div class="absolute right-0 top-0 text-gray-500 p-4 cursor-pointer" @click="show = false"><i class="fas fa-times"></i></div>
            <div class="">
        ...
        @if($selected)
            <div class="mt-5 sm:mt-6">
                <span class="flex w-full rounded-md shadow-sm">
                    <button type="button"
                          class="inline-flex justify-center w-full rounded-md border border-transparent px-4 py-2 bg-blue-500 text-base leading-6 font-medium text-white shadow-sm hover:bg-blue-700 focus:outline-none focus:border-blue-700 focus:shadow-outline-indigo transition ease-in-out duration-150 sm:text-sm sm:leading-5">
