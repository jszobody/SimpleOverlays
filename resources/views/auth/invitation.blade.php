        ...
        <div class="flex flex-wrap justify-center">
            <div class="w-full max-w-sm">
                <div class="flex flex-col break-words bg-white border border-2 rounded shadow-md">
                    ...
                    <form class="w-full p-6" method="POST" action="{{ route('invitation.complete', ['invite' => $invite]) }}">
                        @csrf

                        <div class="flex flex-wrap mb-6 leading-relaxed text-gray-700">
                            Welcome to Eclipse! Please provide your name and pick a password to finish registering your account.
                        </div>
